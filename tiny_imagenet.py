...
# Run this program to download and format the tiny imagenet database
...
def split_train_test():
    ...
    for wnind in wninds:
        ...
        for wdir in dirs:
            ...
            print("[Old] wnind: %s - #: %s" % (wnind, len(imgs)))
            shuffle(imgs)
        ...
        f_ntrain.close()
        f_ntest.close()
        print('[New] wnind: %s - #Train: %s - #Test: %s' % (wnind, wnind_ntrain, wnind_ntest))
    ...
    print("Created new test data at: %s" % new_test_dir)
